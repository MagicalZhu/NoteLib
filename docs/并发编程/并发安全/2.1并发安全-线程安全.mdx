...
- 需要考虑线程安全的常见情况?
  - <font color='red'>访问**共享**的变量或者资源，会有并发风险。</font>
...
1. <font color='red'>当多个线程访问某个对象时,不管这些线程在运行环境下采用哪种调度方式，或者这些线程如何交替运行，并且也不用在主调用代码中进行额外的同步、协同，调用这个对象的行为方法都能获取到**正确的结果**，那么这个对象就是线程安全的</font>
...
<font color='red'>a++自增实质上分为三个步骤: 读取a的值->将值加1->将计算结果写入a</font>, 即 `读取->修改->写入`

<img src='./image/2.并发编程基础/image-20210823212814991.png'/>
...
<img src='./image/2.并发编程基础/image-20210828125545826-0126551.png'/>
...
<img src='./image/2.并发编程基础/image-20210828144043239-0132844.png'/>
...
<img src='./image/2.并发编程基础/image-20210828144607391.png'/>
...
<img src='./image/2.并发编程基础/image-20210828155748074.png'/>
